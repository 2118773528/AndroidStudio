    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBtnJump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("name","ggz");
                bundle.putInt("number",17281147);
...
//                startActivity(intent);
                ...
                //显式3
//                Intent intent = new Intent();
//                intent.setClassName(AActivity.this,"com.example.androidstudio.jump.BActivity");
//                startActivity(intent);

                //显式4
//                Intent intent = new Intent();
//                intent.setComponent(new ComponentName(AActivity.this,"com.example.androidstudio.jump.BActivity"));
//                startActivity(intent);

                //隐式
//                Intent intent = new Intent();
//                intent.setAction("com.example.androidstudio.jump.BActivity");
//                startActivity(intent);
            }
        });
    }
